...
/***/ (function(module, exports) {
	 ...
	 */
	(function () {
	  $.fn.contactDialog = function (options) {
	  ...
	  CDialog.prototype = {
	    ...
	    createPageTwoHtml:function () {
	      ...
	      '<div class="fConRig xjIBox">',
	        '<input type="text" class="telInput" value="">',
	      ...
	      '<div class="fConRig">',
	        ...
	        '<span><b>*</b>手机号：</span>',
	      '<div class="fConRig xjIBox">',
	        '<input type="text" class="telInput" value="13685267305">',
	        ...
	        $.ajax({
	          ...
	          success:function (result) {
	            if (result.tip == "0") {
	              ...
	              /*jQuery("#validate_error").html("<strong></strong>验证码错误，请重新输入");
	              jQuery("#captcha").val("");
	              changeValidPic();
	              ...
	              /*jQuery("#dialogSendMessage").hide();
	              var successTip = '慧聪已向您发送了短信，请查收！您也可扫描右边二维码，关注公众号接收名片消息，并且使用名片夹功能';
	              if (pageIndex == 1) {
	                jQuery("#sendSuccess").find(".tcbx1-2").html(successTip);
	                jQuery("#sendSuccess").show();
	              } else {
	                jQuery(".validatesucc").find("dl dd").html(successTip);
	                jQuery(".validatesucc").show();
	              }*/
