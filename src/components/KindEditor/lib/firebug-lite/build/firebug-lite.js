 ...
 */
var FBL={};
(function(){var productionDir="//getfirebug.com/releases/lite/";
...
this.addScript=function(doc,id,src){var element=doc.createElementNS("//www.w3.org/1999/xhtml","html:script");
...
this.isVisible=function(elt){return this.getStyle(elt,"visibility")!="hidden"&&(elt.offsetWidth>0||elt.offsetHeight>0||elt.tagName in invisibleTags||elt.namespaceURI=="//www.w3.org/2000/svg"||elt.namespaceURI=="//www.w3.org/1998/Math/MathML")
};
...
var isElementMathML=this.isElementMathML=function(node){return node.namespaceURI=="//www.w3.org/1998/Math/MathML"
};
var isElementSVG=this.isElementSVG=function(node){return node.namespaceURI=="//www.w3.org/2000/svg"
};
...
},visitWebsite:function(){this.visit("//getfirebug.com/lite.html")
},visitDiscussionGroup:function(){this.visit("//groups.google.com/group/firebug")
},visitIssueTracker:function(){this.visit("//code.google.com/p/fbug/issues/list")
...
},initialize:function(){if(Env.bookmarkletOutdated){Firebug.Console.logFormatted(["A new bookmarklet version is available. Please visit //getfirebug.com/firebuglite#Install and update it."],Firebug.context,"warn")
...
}},YQL:function(url,callback){var yql="//query.yahooapis.com/v1/public/yql?q=select%20*%20from%20html%20where%20url%3D%22"+encodeURIComponent(url)+"%22&format=xml";
...
}catch(exc){return"//bugzilla.mozilla.org/show_bug.cgi?id=422264"
}},showApplicationCache:function(event){openNewTab("//bugzilla.mozilla.org/show_bug.cgi?id=422264")
...
},show:function(storage){openNewTab("//dev.w3.org/html5/webstorage/#storage-0")
...
var editStyleSheet=ownerNode.ownerDocument.createElementNS("//www.w3.org/1999/xhtml","style");
unwrapObject(editStyleSheet).firebugIgnore=true;
editStyleSheet.setAttribute("type","text/css");
editStyleSheet.setAttributeNS("//www.w3.org/XML/1998/namespace","base",url.directory);
...
externalStyleSheetWarning.tag.append({object:"The stylesheet could not be loaded due to access restrictions. ",link:"more...",href:"//getfirebug.com/wiki/index.php/Firebug_Lite_FAQ#I_keep_seeing_.22Access_to_restricted_URI_denied.22"},this.panelNode);
return
...
}if(externalStyleSheetURLs.length>0){externalStyleSheetWarning.tag.append({object:"The results here may be inaccurate because some stylesheets could not be loaded due to access restrictions. ",link:"more...",href:"//getfirebug.com/wiki/index.php/Firebug_Lite_FAQ#I_keep_seeing_.22This_element_has_no_style_rules.22"},this.panelNode)
