...
test("formatUrl", function() {
	equals(K.formatUrl(K.query("#test01").value, "absolute", '//localhost', '/ke/test'), '/ke/images/xxx.gif');
	equals(K.formatUrl(K.query("#test01").value, "relative", '//localhost', '/ke/test'), '../images/xxx.gif');
	equals(K.formatUrl(K.query("#test01").value, "domain", '//localhost', '/ke/test'), '//localhost/ke/images/xxx.gif');
	equals(K.formatUrl(K.query("#test01").value), '../images/xxx.gif');

	equals(K.formatUrl(K.query("#test02").value, "absolute", '//localhost:8080', '/ke/test'), '/images/xxx.gif');
	equals(K.formatUrl(K.query("#test02").value, "relative", '//localhost:8080', '/ke/test'), '../../images/xxx.gif');
	equals(K.formatUrl(K.query("#test02").value, "domain", '//localhost:8080', '/ke/test'), '//localhost:8080/images/xxx.gif');
	equals(K.formatUrl(K.query("#test02").value), './../../images/xxx.gif');

	equals(K.formatUrl(K.query("#test03").value, "absolute", '//localhost', '/ke/test'), '/ke/images/xxx.gif');
	equals(K.formatUrl(K.query("#test03").value, "relative", '//localhost', '/ke/test'), '../images/xxx.gif');
	equals(K.formatUrl(K.query("#test03").value, "domain", '//localhost', '/ke/test'), '//localhost/ke/images/xxx.gif');
	equals(K.formatUrl(K.query("#test03").value), '/ke/images/xxx.gif');

	equals(K.formatUrl(K.query("#test04").value, "absolute", '//localhost', '/ke/test'), '/ke/images/xxx.gif');
	equals(K.formatUrl(K.query("#test04").value, "relative", '//localhost', '/ke/images'), 'xxx.gif');
	equals(K.formatUrl(K.query("#test04").value, "domain", '//localhost', '/ke'), '//localhost/ke/images/xxx.gif');
	equals(K.formatUrl(K.query("#test04").value), '//localhost/ke/images/xxx.gif');

	equals(K.formatUrl(K.query("#test05").value, "absolute", '//localhost', '/ke'), '//www.163.com/images/xxx.gif');
	equals(K.formatUrl(K.query("#test05").value, "relative", '//localhost', '/ke'), '//www.163.com/images/xxx.gif');
	equals(K.formatUrl(K.query("#test05").value, "domain", '//localhost', '/ke'), '//www.163.com/images/xxx.gif');
	equals(K.formatUrl(K.query("#test05").value), '//www.163.com/images/xxx.gif');

	equals(K.formatUrl(K.query("#test06").value, "absolute", '//kindsoft.net', '/'), '/kindeditor/plugins/emoticons/etc_01.gif');
	equals(K.formatUrl(K.query("#test06").value, "relative", '//kindsoft.net', '/'), 'kindeditor/plugins/emoticons/etc_01.gif');
	equals(K.formatUrl(K.query("#test06").value, "domain", '//kindsoft.net', '/'), '//kindsoft.net/kindeditor/plugins/emoticons/etc_01.gif');
	equals(K.formatUrl(K.query("#test06").value), '//kindsoft.net/kindeditor/plugins/emoticons/etc_01.gif');

	equals(K.formatUrl(K.query("#test07").value, "absolute", '//kindsoft.net', '/'), 'mailto:test@test.com');
	equals(K.formatUrl(K.query("#test07").value, "relative", '//kindsoft.net', '/'), 'mailto:test@test.com');
	equals(K.formatUrl(K.query("#test07").value, "domain", '//kindsoft.net', '/'), 'mailto:test@test.com');
	equals(K.formatUrl(K.query("#test07").value), 'mailto:test@test.com');

	equals(K.formatUrl('//static.domain.com/img//123.png'), '//static.domain.com/img/123.png');
