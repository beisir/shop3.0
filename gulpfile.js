...
gulp.task('upload', function() {
	...
	return gulp.src(globs, {
		...
		.pipe(conn.newer('/Aries/Project/20170928-newshop30/style/js/module/shop3.0/')) // only upload newer files
		.pipe(conn.dest('/Aries/Project/20170928-newshop30/style/js/module/shop3.0/'));
});
